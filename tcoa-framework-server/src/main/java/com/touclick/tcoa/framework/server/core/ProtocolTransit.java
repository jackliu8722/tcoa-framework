 ...
 */
public class ProtocolTransit extends TProtocol {
    TProtocol source = null;
    StringBuffer sb  = null;
    String funcName;

    public static ProtocolTransit getProtocol(TProtocol in) {
        ProtocolTransit protocol = new ProtocolTransit(in.getTransport());
     ...
     * 主要用于兼容父类
     */
    protected ProtocolTransit(TTransport trans) {
        super(trans);
    }
    ...
    public TStruct readStructBegin() throws TException {
        ...
        sb.append("Sturct:").append(value.name).append("(");
        return value;
    }
